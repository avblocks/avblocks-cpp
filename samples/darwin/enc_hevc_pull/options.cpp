...
{
    cout << "enc_hevc_pull --frame <width>x<height> --rate <fps> --color <COLOR> --input <file.yuv> --output <file.h265>" << endl
    << "[--colors]" << endl;
    doHelp(cout, optcfg);
}
...
bool validateOptions(Options& opt)
{
    ...
    {
        cout << "output file: " << opt.h265_file << endl;
    }
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    if (argc < 2)
    {
        ...
        cout << "Using defaults:\n";
        cout << "enc_hevc_pull --input " << opt.yuv_file;
    ...
    (("output,o"),	opt.h265_file,          string(),		("output H265 file"))
