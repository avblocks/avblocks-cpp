...
void setDefaultOptions(Options& opt)
{
    ...
    fs::path output(getExeDir() + "/../../output/enc_vp8_file");
...
{
    cout << "enc_vp8_file --frame <width>x<height> --rate <fps> --color <COLOR> --input <file.yuv> --output <file.ivf>" << endl
    << "[--colors]" << endl;
    doHelp(cout, optcfg);
}
...
ErrorCodes prepareOptions(Options &opt, int argc, char* argv[])
{
    if (argc < 2)
    {
        ...
        cout << "Using defaults:\n";
        cout << "enc_vp8_file --input " << opt.yuv_file;
