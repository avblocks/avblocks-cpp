...
2. Run the sample from the sample directory (the input/output file paths are relative to the working directory):
    ...
    ```sh
    cd samples/linux/simple_video_framerate
    ../../../bin/x64/simple_video_framerate
    ```

3. The converted output file `AndrewConnolly_2014_30fps.mp4` will be created in the `samples/linux/simple_video_framerate` directory.
