...
The built executable will be placed in `bin\x64\simple_video_pad.exe`.
...
2. Run the sample from the sample directory (the input/output file paths are relative to the working directory):
    ...
    ```powershell
    cd samples\windows\simple_video_pad
    ..\..\..\bin\x64\simple_video_pad.exe
    ```

3. The padded output file `AndrewConnolly_2014_640x480_Padded.mp4` will be created in the `samples\windows\simple_video_pad` directory.
